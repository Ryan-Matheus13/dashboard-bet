...
import { addStorySchema } from "./ValidationSchema";

import { useFormik } from "formik";

import { AddStoryFormProps, AddStoryFormValues } from "./Form.types";
...
const AddStoriesForm: React.FC<AddStoryFormProps> = ({ close }) => {
  const [loading, setLoading] = useState(false);

  const formik = useFormik<AddStoryFormValues>({
    initialValues,
  ...
  const handleSubmit = async (data: AddStoryFormValues) => {
    ...
    try {
      ...
      console.error("Erro ao tentar criar um story:", error);
      toast.error("Erro ao tentar criar um story.");
    }
  };
